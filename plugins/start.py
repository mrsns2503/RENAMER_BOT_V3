...
async def start(client,message):
	...
	**Document Or Video** and enter new filename to rename it__
	...
	reply_markup=InlineKeyboardMarkup(
	 [[ InlineKeyboardButton("✪ 𝐔𝐏𝐃𝐀𝐓𝐄𝐒 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✪" ,url="https://t.me/SNSxTG") ], 
	[InlineKeyboardButton("🎬 𝐌𝐎𝐕𝐈𝐄 𝐆𝐑𝐎𝐔𝐏 🍿", url="https://t.me/+7j7EXi8FELQ2MjU9") ]  ]))
	    return
	if id:
	    if old == True:
	        try:
...
async def send_doc(client,message):
       ...
       if update_channel :
       	try:
       		...
       		await message.reply_text("**__You have not subscribed my channel yet__** ",
       		reply_to_message_id = message.id,
       		reply_markup = InlineKeyboardMarkup(
       		[ [ InlineKeyboardButton("✠ 𝐌𝐀𝐈𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✠" ,url=f"https://t.me/{update_channel}") ]   ]))
       		return
       try:
